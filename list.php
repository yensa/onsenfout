            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right">ajouté un utilisateur</a>
                    </div>
                    <?php
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='read.php?ID=". $row['IDcontact'] ."' title='voir' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                                            echo "<a href='update.php?ID=". $row['IDcontact'] ."' title='maj' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
